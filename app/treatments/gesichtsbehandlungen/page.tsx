...
export const metadata = constructMetadata({
  title: 'Gesichtsbehandlungen | Le Rêve',
  description: 'Strahlende Haut und tiefenwirksame Pflege.',
  path: '/treatments/gesichtsbehandlungen'
});

export default function Gesichtsbehandlungen() {
  const services = [
    { name: "Express Glow", time: "30min", price: "45€" },
    { name: "Deep Cleansing", time: "60min", price: "75€" },
    { name: "Anti-Aging Premium", time: "90min", price: "115€" },
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
      <div className="text-center space-y-6">
        ...
        <h1 className="font-serif text-5xl md:text-6xl text-primary">Gesichtsbehandlungen</h1>
        <p className="text-text-light text-xl font-light">Strahlende Haut und tiefenwirksame Pflege.</p>
      </div>
      ...
      <div className="glass-panel p-8 md:p-16 rounded-[3rem] space-y-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <p className="text-text-main text-lg leading-relaxed font-light mb-8 max-w-2xl mx-auto text-center">
            Gönnen Sie Ihrer Haut die Pflege, die sie verdient. Mit hochwertigen Produkten reinigen, nähren und verjüngen wir Ihre Haut für einen frischen, strahlenden Teint.
          </p>
